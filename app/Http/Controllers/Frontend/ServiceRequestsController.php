...
class ServiceRequestsController extends Controller
{
    ...
    public function index()
    {
        ...
        $serviceRequests = ServiceRequest::with(['service', 'pet', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.serviceRequests.create', compact('pets', 'services'));
    }
    ...
    public function edit(ServiceRequest $serviceRequest)
    {
        ...
        $serviceRequest->load('service', 'pet', 'created_by');

        return view('frontend.serviceRequests.edit', compact('pets', 'serviceRequest', 'services'));
    }
