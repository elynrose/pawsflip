...
class CreditsController extends Controller
{
    public function index()
    {
        ...
        $credits = Credit::with(['service_request', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.credits.create', compact('service_requests'));
    }
    ...
    public function edit(Credit $credit)
    {
        ...
        $credit->load('service_request', 'created_by');

        return view('frontend.credits.edit', compact('credit', 'service_requests'));
    }
