...
class AvailabilityController extends Controller
{
    ...
    public function index()
    {
        ...
        $availabilities = Availability::with(['service', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.availabilities.create', compact('services'));
    }
    ...
    public function edit(Availability $availability)
    {
        ...
        $availability->load('service', 'created_by');

        return view('frontend.availabilities.edit', compact('availability', 'services'));
    }
