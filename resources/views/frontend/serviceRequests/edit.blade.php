                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.service-requests.update", [$serviceRequest->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="zip_code" id="zip_code" value="{{ old('zip_code', $serviceRequest->zip_code) }}" step="1" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="closed" id="closed" value="1" {{ $serviceRequest->closed || old('closed', 0) === 1 ? 'checked' : '' }}>
