        ...
        <div class="col-md-12">
            @can('service_request_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.service-requests.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $serviceRequest->id }}">
                                        ...
                                        <td>
                                            @can('service_request_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.service-requests.show', $serviceRequest->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('service_request_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.service-requests.edit', $serviceRequest->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
